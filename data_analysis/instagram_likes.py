# data_analysis/instagram_likes.py
import json
...
def run_instagram_analysis():
    ...
    with open(data_path("Instagram", "your_instagram_activity", "likes", "liked_posts.json"), "r") as file:
        data = json.load(file)
...
if __name__ == "__main__":
    for account, count in run_instagram_analysis().items():
